...
addToCart = function(asin, offerListingId, quantity) {
    console.log("Add to cart...");
    const url = `https://www.amazon.com/alm/addtofreshcart?ref_=sr_1_3&qid=1637172446&sr=1-3&discoveredAsins.0=${asin}`
    fetch(url, {
        "headers": {
            "accept": "*/*",
        ...
        "body": `{\"clientID\":\"p13n-alm-cards-alm-carousel-desktop\",\"reftag\":\"pd_alm_md_dsk_sf_rtd_1_3_atc\",\"queryLogInfoParams\":{\"pd_rd_i\":\"${asin}\",\"pd_rd_w\":\"cJKJm\",\"pf_rd_p\":\"52f06a81-c528-46a3-bf8e-a46fd30f5ec5\",\"pf_rd_r\":\"MCHKRJV2Z2EVWEFFVFT4\",\"pd_rd_r\":\"86a85fd0-3aee-4d92-ab22-cc7ea23bfd7e\",\"pd_rd_wg\":\"QqKId\"},\"additionalParams\":{\"widgetId\":\"parentCarousel-desktop-alm-storefront_AlmRegionalTrendingItems\"},\"sessionID\":\"132-6285241-0758213\",\"csrfToken\":\"g8OOQoPNbc+keQQ49W6p7rIp/EyjDsddv1+9ZiT+1n46AAAAAQAAAABhlY+lcmF3AAAAAPxEJ5HRQInxPcX7Afa6ow==\",\"asin\":\"${asin}\",\"promotionId\":\"any\",\"offerListingID\":\"${offerListingId}\",\"brandId\":\"QW1hem9uIEZyZXNo\",\"storeId\":\"2d0da482c8c6360e56479a704530af44737d1c3a\",\"isItemSoldByCount\":true,\"isItemPricedByCount\":true,\"quantity\":\"${quantity}\"}`,
        "method": "POST"
    }).then(res => {
        console.log(res);
        res.json();
